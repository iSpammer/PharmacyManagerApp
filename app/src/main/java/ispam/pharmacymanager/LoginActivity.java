...
import ispam.pharmacymanager.api.ApiController;
...
public class LoginActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //Local Phone SQLite database handler
        db = new SQLiteHandler(getApplicationContext());

        // Session manager (by save en el user logged in wala la2)
        ...
        // On Button Click efta7 Register Screen
    ...
    /**
     * function to verify login details in node mongodb
     */
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!error) {
                        ...
                        // Now store the user in local phone SQLite
